...
This arrangement makes it possible to control the laser power, excitation time and the delay time to start acquiring the spectrum.
...
\begin{table}[ht]
	...
	\begin{tabular}{|l*{5}{|c}|}
		\hline
		Sample Type & No. of Samples & \multicolumn{2}{c|}{Measurement 1} & \multicolumn{2}{c|}{Measurement 2}\\
		\cline{3-6}
		{}& {} & $\mathrm{P_{laser}}$ [mW] & $\mathrm{t_{ex}}$ [ms] & $\mathrm{P_{laser}}$ [mW] & $\mathrm{t_{ex}}$ [ms]\\
		\hline
		Non-plastic & 12 & 0.5\textendash130 & 300 & 0.2\textendash2.8 & 300\\
		\hline
...
Table~\ref{tab:samples} gives a summary of all samples with the range of the measurement parameters used in this study.
