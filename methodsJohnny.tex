...
All spectra are measured over the full range of the spectrometer are between 200\textendash1000 nm.
For each sample and setup, we take 9 to 20 measurements to capture spectral variations during acquisition.
Each measurement is associated to a measured spectrum of the background noise.
