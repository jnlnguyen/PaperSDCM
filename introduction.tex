...
Plastic litter can persist for decades as most types are resistant to natural degradation processes\cite{Chamas2020}.
...
An analysis of the stripped-down dataset can reveal signatures for groups of samples with common properties, such as, plastic type or color. 
...
The latter is advanteagous as it improves our ability to track the sample origin down to a single source.
To demonstrate this, we generate ML models with one of five different classification methods and one of four transformation algorithms.
