...
Once plastic waste finds its way into our environment, they can persist for centuries as most plastic types are resistant to natural degradation processes.
...
Almost invisible to the eye, they can be ingested by organisms and lifeforms with potential impacts on entire food networks.
spätestens als microplastik in der plazenta nachgewiesen wurde, sollte klar sein dass detektion wichtig ist.


As such, identification tools are stron
